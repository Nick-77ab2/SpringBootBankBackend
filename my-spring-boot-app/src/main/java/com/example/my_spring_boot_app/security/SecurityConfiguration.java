    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/authentication", "/register", "/api/bank/balance/{username}", "/api/bank/addbalance/{username}", "/api/bank/removebalance/{username}", "/api/bank/transfer", "/api/verify", "/api/passwordReset", "/api/passwordReset/reset").permitAll()
